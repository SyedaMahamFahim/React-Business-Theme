        ...
        <div className="content">
          <div className="left box">
            ...
            <div className="lower">
              ...
              <div className="phone">
                <Link to="/" className="footer-links"><i className="fas fa-phone-volume" />+007 9089 6767</Link>
              </div>
              <div className="email">
                <Link to="/" className="footer-links" ><i className="fas fa-envelope" />abc@gmail.com</Link>
              </div>
            </div>
          </div>
...

{
     SocialLinkData.map((item, index) => {
        return (
            <Link to={item.url} className="soical-links" key={index}>
        ...
        <div className="bottom">
          <p>Copyright © 2021 <Link to="/">Xnitia</Link> All rights reserved</p>
        </div>
      </footer>
        </>
    )
